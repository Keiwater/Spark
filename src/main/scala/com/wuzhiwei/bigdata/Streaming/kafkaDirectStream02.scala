...
object kafkaDirectStream02 {
  ...
  /**
    *
    * 直接使用 zookeeper 记录指定topic的groupid 的数据消费偏移量，而不需要使用checkpoint
    *
    *
    * @param args
    */
  ...
  def main(args: Array[String]): Unit = {
    ...
    //    创建SparkConf
    val conf: SparkConf = new SparkConf().setAppName("kafkaDirectStream02").setMaster("local[*]")
